...
const ThoughtForm = ({ updateThoughts }) => {
  ...
  // function when users selects the upload button
  ...
  const handleFormSubmit = (event) => {
    ...
    const postData = async () => {
      ...
      // calling function from props import
      updateThoughts();
    ...
    <div>
      ...
      >
        ...
        <label className="form-input col-12 p-1">
          ...
          <button className="btn" onClick={handleImageUpload} type='submit'>Upload</button>
        </label>
